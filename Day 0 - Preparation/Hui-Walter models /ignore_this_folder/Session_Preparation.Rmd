---
title: "Pre-course material - HARMONY - Grant Period 4 - Nantes Training School 7 - 9 June 2023"
author:
...
We have created a public repository containing the teaching material for the training workshop.  This means that anyone can view the teaching material at any time via the following website: https://github.com/LefMel/harmony-nantes-2023
...
The easiest way to clone the `harmony-nantes-2023` repository on to your computer is via RStudio. Go to the `File` menu and select `New project`. It will open and wizard menu, giving you three alternative ways to create a project: select `Version Control` and then `GIT`. Then type/paste `https://github.com/LefMel/harmony-nantes-2023.git` into the box where it says `Repository URL`. A suggested local path folder will be created automatically at the bottom but feel free to change this. Then click on `Clone` and wait for the files to download.
